        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal animation="slide-right" delay={150}>
              ...
              {/* Interactive SVG Map */}
              <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg aspect-[16/7] relative overflow-hidden">
                <svg
                  viewBox="0 0 460 180"
                ...
                {hoveredRegion && (
                  <div
                    className="absolute pointer-events-none bg-white shadow-lg rounded-md px-3 py-1.5 text-xs font-body font-medium text-gray-900 border border-gray-200 z-10 whitespace-nowrap"
                    style={{
                      left: tooltipPos.x,
                      top: tooltipPos.y,
